    ...
    <div className='container mx-auto min-h-[800px] mb-14'>
      <div className='flex flex-col lg:flex-row lg:items-center lg:justify-between'>
        ...
        <div className='mb-4 lg:mb-0 flex gap-x-2 text-sm'>
          <div className='bg-green-500 p-2 rounded-lg text-white px-3 inline-block'>
            {property.type}
          </div>
          <div className='bg-violet-500 p-2 rounded-lg text-white px-3 inline-block'>
            {property.country}
          </div>
        </div>
      ...
      <div className='flex flex-col items-start gap-8 p-2 lg:flex-row'>
